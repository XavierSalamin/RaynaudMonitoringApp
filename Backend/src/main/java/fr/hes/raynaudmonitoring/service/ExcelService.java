...
import fr.hes.raynaudmonitoring.dao.RcsRepository;
import fr.hes.raynaudmonitoring.dao.TreatmentRepository;
...
import fr.hes.raynaudmonitoring.utils.CrisisUtils;
import fr.hes.raynaudmonitoring.utils.DateUtils;
import fr.hes.raynaudmonitoring.utils.FileDownloadUtils;
...
public class ExcelService {
	...
	public ResponseEntity<StreamingResponseBody> generateExcelById(final String patientNumber, final HttpServletResponse response) {
		...
		if (patientNumber != null) {
			...
			try {
				...
				return FileDownloadUtils.downloadAsStreamingResponseBody(wb, FILENAME, true);


			} catch (final IOException e) {
				logger.error("There was an error creating the excel file", e);
			}
		}
