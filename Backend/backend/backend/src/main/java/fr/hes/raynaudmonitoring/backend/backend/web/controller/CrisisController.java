...
import fr.hes.raynaudmonitoring.backend.backend.service.ExcelService;
...
public class CrisisController {
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public void generateExcelById(@PathVariable final String patientNumber, final HttpServletResponse response) {
		logger.info("Trying to generate excel");
		excelService.generateExcelById(Integer.valueOf(patientNumber), response);
	}
